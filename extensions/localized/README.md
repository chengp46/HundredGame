...
After enabling the extension, click `Panel -> localized -> Default Panel` in the main menu bar to open the default panel of the extension.

To send a message to the default panel, click `Developer -> localized -> Send Message to Panel` at the top of the menu. If the default panel
